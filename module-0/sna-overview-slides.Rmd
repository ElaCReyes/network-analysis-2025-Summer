...
.font70[
- [SNA Case Study: A Tale of Two MOOCs - KEY](https://github.com/ElaCReyes/network-analysis-2025-Summer/blob/main/module-2/sna-2-case-study-R.qmd) You may use Posit or Download the file and work in RStudio
...
- [SNA Case Study - KEY](https://elacreyes.github.io/network-analysis-2025-Summer/module-3/sna-lab-3-case-study-key.html) Open in Case of Emergency :D
...
.font70[
- [SNA Case Study: Birds of a Feather Lead Together](https://github.com/ElaCReyes/network-analysis-2025-Summer/blob/main/module-4/sna-4-case-study-R.qmd)

- [SNA Case Study - KEY](https://elacreyes.github.io/network-analysis-2025-Summer/module-4/sna-lab-4-case-study-key.html)
