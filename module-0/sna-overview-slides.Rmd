...
Social network analysis is based on **ties** connecting social *actors* (aka nodes, people) and is motivated by our intuition that relationships between individuals matter:
...
.pull-left[
It makes use of **graphic imagery** (graph theory) to represent actors and their relations with one another.
